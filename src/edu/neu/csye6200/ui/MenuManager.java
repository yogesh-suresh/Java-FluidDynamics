...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(WApp application) {
	 ...
	 */
	public MenuManager(WApp application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(WApp application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		private WApp application;

		protected ExitAction(WApp application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(WApp application) {
			super("AboutAction");
			this.application = application;
		}
